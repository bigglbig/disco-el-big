...
ITEM.width = 1
ITEM.height = 1
ITEM.description = "Ручное устройство, предназначенное для зажигания пламени, чтобы поджигать предметы."
...
function ITEM:OnRunLight()
	...
	client:NotifyLocalized("Вы начинаете курить сигарету.")
