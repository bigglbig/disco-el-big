...
ITEM.name = "Сигарета"
ITEM.description = "Просто сигарета."
...
function ITEM:OnRunSmoke()
    ...
    client:NotifyLocalized("Вставьте сигарету в рот. Зажгите ее с помощью зажигалки.")
end
...
function ITEM:OnRunStopSmoke(client, value, bRemove)
    ...
    client:NotifyLocalized(self:GetData("length") == 1 and "Вы докурили сигарету - остался только окурок" or "Вы вынули сигарету изо рта.")
...
ITEM.functions.smoke = {
    name = "Поместите в рот",
	tip = "Поместите сигарету в рот.",
...
ITEM.functions.stopsmoke = {
    name = "Вынуть изо рта",
	tip = "Убрать сигарету изо рта и погасите ее.",
	icon = "icon16/brick_add.png",
	OnRun = function(item)
        item:OnRunStopSmoke()
